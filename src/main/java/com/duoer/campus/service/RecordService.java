...
public interface RecordService {
     ...
     * @return 记录
     */
    RecordDTO getRecordById(int id, String type);
     ...
     * @return 记录
     */
    RecordDTO getTempRecordById(int id, String type);
     ...
     * @return 所有记录集合
     */
    List<? extends RecordDTO> getCatOwnRecords(int id, String type);
     ...
     * @return 状态码
     */
    int deleteTempRecord(List<Integer> ids, String type);
}
